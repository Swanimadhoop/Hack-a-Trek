            ...
            <div className="div-2"> 
                ...
                <div className="overlap-3"> 
                    ...
                    <p className="applied-hackathons"> 
                        <span className="text-wrapper-3"> Previously <br /> </span> 
                        <span className="text-wrapper-2"> Conducted <br /> <br /> </span> 
                        <span className="text-wrapper-4"> Hackathons <br /> <br /> </span> 
                    ...
                    <p className="YOUR-PROJECTS"> 
                        <span className="text-wrapper-2"> Upcoming <br /> </span> 
                        <span className="text-wrapper-3"> Hackathons <br /> </span> 
